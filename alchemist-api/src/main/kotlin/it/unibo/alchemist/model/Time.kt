    ...
    companion object {
        ...
        val ZERO: Time =
            object : Time {
                ...
                override fun times(other: Double): Time = takeIf { other.isFinite() } ?: error("Cannot multiply zero by $other")
        ...
        val INFINITY: Time =
            object : Time {
                ...
                override fun minus(other: Time) = takeUnless { other == this } ?: error("Cannot subtract an infinite time from $this")
        ...
        val NEGATIVE_INFINITY: Time =
            object : Time by INFINITY {
                ...
                override fun minus(other: Time) = takeUnless { other == this } ?: error("Cannot sum an infinite time to $this")

                override fun plus(other: Time) = takeUnless { other == INFINITY } ?: error("Cannot sum an infinite time to $this")
