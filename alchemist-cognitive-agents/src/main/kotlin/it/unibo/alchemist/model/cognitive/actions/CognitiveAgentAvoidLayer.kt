...
class CognitiveAgentAvoidLayer
    ...
    constructor(
        ...
        override fun cloneAction(
            node: Node<Number>,
            reaction: Reaction<Number>,
        ): CognitiveAgentAvoidLayer = CognitiveAgentAvoidLayer(environment, reaction, node.pedestrianProperty, targetMolecule, viewDepth)
        ...
        private fun isDangerInSight(): Boolean =
            getLayerOrFail().center()?.let { center ->
