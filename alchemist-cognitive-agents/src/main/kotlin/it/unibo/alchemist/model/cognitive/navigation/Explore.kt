...
open class Explore<T, L : Euclidean2DConvexShape, R>(
     ...
     */
    protected open fun volatileMemoryFactor(head: ConvexPolygon): Double = 2.0.pow(orientingCapability.volatileMemory[head] ?: 0)
     ...
     */
    protected open fun impasseFactor(head: ConvexPolygon): Double = knownImpasseWeight.takeIf { head.isKnownImpasse() } ?: 1.0
