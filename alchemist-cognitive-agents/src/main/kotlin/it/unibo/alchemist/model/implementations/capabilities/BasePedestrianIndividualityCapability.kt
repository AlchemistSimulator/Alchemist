 ...
 */
data class BasePedestrianIndividualityCapability<T, S : Vector<S>, A : GeometricTransformation<S>> @JvmOverloads constructor(
...
) : PedestrianIndividualityCapability<T, S, A>
