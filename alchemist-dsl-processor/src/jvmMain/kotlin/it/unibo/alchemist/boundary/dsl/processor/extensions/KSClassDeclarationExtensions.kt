 ...
 */
internal fun KSClassDeclaration.findConstructor(): KSFunctionDeclaration? = primaryConstructor?.takeIf { it.isPublic() }
    ?: getAllFunctions()
        .filter { it.isPublic() && it.simpleName.asString() in listOf("<init>", simpleName.asString()) }
