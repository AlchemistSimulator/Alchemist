 ...
 * (Reactions) being reactive based on what they [observe][it.unibo.alchemist.model.observation.Observable].
 * Sources' (nodes' contents, positions, neighborhoods, ...) changes will automatically trigger reactions
