...
class SlopeInterceptLine2D<P : Vector2D<P>> private constructor(
    ...
    private fun parallelTo(other: Line2D<*>): Boolean = isVertical && other.isVertical || fuzzyEquals(slope, other.slope)
    ...
    override fun intersect(other: Line2D<P>): Intersection2D<P> =
        when {
            coincidesWith(other) ->
