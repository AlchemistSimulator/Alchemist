...
class TestAbstractConvexPolygon : StringSpec({
    ...
    fun createPolygon(vararg coords: Euclidean2DPosition): MutableConvexPolygon = AwtMutableConvexPolygon(coords.toMutableList())
    ...
    fun createRectangle(
        ...
        width: Double,
        height: Double,
    ): MutableConvexPolygon = createPolygon(coords(x, y), coords(x + width, y), coords(x + width, y + height), coords(x, y + height))
