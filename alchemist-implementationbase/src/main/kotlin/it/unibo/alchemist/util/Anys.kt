...
object Anys {
     ...
     *
     * @param E the element type produced by unfolding
     * @receiver The starting element to unfold
     * @param extractor A function that provides a sequence of elements given a specific element of the same type
     * @return A sequence of [E] generated by unfolding on each element provided by the [extractor] function
     * @see fold
     */
