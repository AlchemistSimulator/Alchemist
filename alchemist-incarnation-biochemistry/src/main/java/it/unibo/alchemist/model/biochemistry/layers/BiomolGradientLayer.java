...
public final class BiomolGradientLayer<P extends Position2D<P>> implements Layer<Double, P> {
    ...
    public BiomolGradientLayer(
        ...
        // initialize the parameters of the plan representing the gradient.
        c = offset;
        a = unitVariation * vx;
        b = unitVariation * vy;
    }
     ...
     *                  in which the gradient grows (here the positions are considered as a vector)
     * @param unitVariation unit variation of the gradient
     * @param offset minimum value of concentration reached by this spatial distribution
     */
    ...
    /**
     * @return the parameters describing this spatial distribution, that's actually a plain.
     *     So the {@link java.lang.reflect.Array} a returned by this method contains the parameters of that plain
