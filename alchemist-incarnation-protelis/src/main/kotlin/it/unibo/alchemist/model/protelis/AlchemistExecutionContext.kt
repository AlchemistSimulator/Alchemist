...
class AlchemistExecutionContext<P : Position<P>>
    ...
    constructor(
        ...
        override fun instance(): AlchemistExecutionContext<P> =
        ...
        override fun nbrLag(): Field<Number> =
            buildField<Double, Number>(
        ...
        override fun nbrVector(): Field<Tuple> =
            buildFieldWithPosition { p: P ->
        ...
        fun routingDistance(dest: Node<Any>): Double =
            routingDistance(environmentAccess.getPosition(dest) as GeoPosition)
