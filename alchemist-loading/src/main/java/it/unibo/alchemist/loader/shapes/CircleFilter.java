 ...
 */
public class CircleFilter<P extends Position2D<P>> extends Abstract2DShapeFilter<P> {
     ...
     */
    public CircleFilter(final double centerx, final double centery, final double radius) {
