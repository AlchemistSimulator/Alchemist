    ...
    constructor(
        ...
        private companion object {
            ...
            private val dateFormat =
                SimpleDateFormat("yyyy-MM-dd'T'HH:mmZ", Locale.US).apply {
             ...
             */
            private val mapsWithPredictableIteration: List<KClass<out Map<*, *>>> =
                listOf(
                    LinkedHashMap::class,
                    SortedMap::class,
                )

            private val Map<String, Any>.hasPredictableIteration get() =
                mapsWithPredictableIteration.any { kclass ->
