...
data class JaktaTimeDistribution(
    ...
    private fun doNotUse(): Nothing = error(
        "${this::class.simpleName} is not meant to be used directly, but to host custom time distributions for the " +
            "sense, deliberate, and act phases of the JaKtA lifecycle.",
    )
}
