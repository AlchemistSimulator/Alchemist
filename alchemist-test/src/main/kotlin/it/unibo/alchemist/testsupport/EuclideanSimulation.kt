...
fun <T, P> EuclideanEnvironment<T, P>.startSimulation(
    ...
    atEachStep: (EuclideanEnvironment<T, P>, GlobalReaction<T>?, Time, Long) -> Unit = { _, _, _, _ -> },
    ...
    Engine(this, steps).apply {
        ...
        addOutputMonitor(
            object : OutputMonitor<T, P> {
                ...
                override fun stepDone(environment: Environment<T, P>, reaction: GlobalReaction<T>?, t: Time, s: Long) {
                    checkForErrors()
