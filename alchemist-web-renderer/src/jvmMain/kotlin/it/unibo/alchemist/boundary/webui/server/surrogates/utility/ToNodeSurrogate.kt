...
/**
 * A function that maps a [it.unibo.alchemist.model.Node] to its surrogate class
 * [it.unibo.alchemist.boundary.webui.common.model.surrogate.NodeSurrogate].
 ...
 * @return the [it.unibo.alchemist.boundary.webui.common.model.surrogate.NodeSurrogate] mapped starting from the
