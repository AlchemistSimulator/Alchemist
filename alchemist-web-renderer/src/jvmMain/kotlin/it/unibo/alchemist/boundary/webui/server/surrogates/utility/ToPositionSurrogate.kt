...
object ToPositionSurrogate {
     ...
     * [it.unibo.alchemist.boundary.webui.common.model.surrogate.Position2DSurrogate] surrogate class. This works only
     * if the position is a [it.unibo.alchemist.model.Position2D].
     */
    ...
    /**
     * @return A function that maps a [it.unibo.alchemist.model.Position] to its surrogate class.
     */
