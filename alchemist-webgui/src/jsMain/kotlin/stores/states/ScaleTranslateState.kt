 ...
 * @property translate The translation offset applied to the graphical elements, represented as a pair of (x, y)
 * coordinates. Defaults to (0.0, 0.0).
 * @constructor Creates a ScaleTranslateState with the specified scaling factor and translation offset, which default
 * to DEFAULT_SCALE and (0.0, 0.0) respectively.
 */
