 ...
 */
internal fun coords(x: Double, y: Double) = Euclidean2DPosition(x, y)

/**
 * Creates a [Segment2D].
 */
internal fun segment(x1: Double, y1: Double, x2: Double, y2: Double) =
    BaseSegment2D(coords(x1, y1), coords(x2, y2))

class TestBaseSegment2D : StringSpec() {
