...
import it.unibo.alchemist.model.implementations.environments.EuclideanPhysics2DEnvironment
...
class TestEuclideanPhysics2DEnvironment : StringSpec() {
    private lateinit var env: Physics2DEnvironment<Any, Euclidean2DPosition>
    ...
    override fun beforeTest(testCase: TestCase) {
        ...
        env = EuclideanPhysics2DEnvironment()
    ...
    init {
        ...
        "Get nodes within a shape" {
            ...
            val shape: GeometricShape2D<Euclidean2DPosition> =
                env.shapeFactory.rectangle(5.1 * NODE_SIZE, NODE_SIZE / 2)
