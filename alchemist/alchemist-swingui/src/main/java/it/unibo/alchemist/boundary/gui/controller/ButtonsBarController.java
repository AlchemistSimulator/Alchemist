...
public class ButtonsBarController implements Initializable {
    ...
    private ButtonBar controlTypeButtonBar;
    ...
    public void initialize(final URL location, final ResourceBundle resources) {
        ...
        assert startStopButton != null : FXResourceLoader.getInjectionErrorMessage("startStopButton",
                BUTTONS_BAR_LAYOUT);
        ...
        assert fullscreenToggle != null : FXResourceLoader.getInjectionErrorMessage("fullscreenToggle",
                BUTTONS_BAR_LAYOUT);

        startStopButton.setText("");
        final IconNode play = new IconNode(GoogleMaterialDesignIcons.PLAY_ARROW);
        ...
        controlType.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(final ActionEvent event) {
                // Lazy initialization of the PopOver
                if (controlTypePopOver == null) {
                    panButton = new JFXButton();
                    controlTypeButtonBar = new ButtonBar();
                    controlTypePopOver = new PopOver(controlTypeButtonBar);
                }
