...
public class DrawCognitiveMap extends DrawOnce {
    ...
    @Override
    public <T, P extends Position2D<P>> void apply(final Graphics2D g, final Node<T> n, final Environment<T, P> env, final BidimensionalWormhole<P> wormhole) {
    ...
    private <P extends Position2D<P>> Shape mapEnvEllipseToAwtShape(final Ellipse e, final BidimensionalWormhole<P> wormhole, final Environment<?, P> env) {
