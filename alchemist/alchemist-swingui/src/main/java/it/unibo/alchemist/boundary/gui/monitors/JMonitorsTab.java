...
public class JMonitorsTab<T> extends JTapeTab implements ItemListener {
    ...
    private static final String MONITORS = ResourceAccess.getString("monitors");
    private final JButton btnAddMonitor = new JButton(ResourceAccess.getString("attach_monitor"));
    private final JButton btnRemMonitor = new JButton(ResourceAccess.getString("detach_monitor"));
    ...
    public JMonitorsTab() {
        ...
        final JTapeGroup monitorsGroup1 = new JTapeGroup(ResourceAccess.getString("monitors"));
        final JTapeGroup monitorsGroup2 = new JTapeGroup(ResourceAccess.getString("monitors"));
