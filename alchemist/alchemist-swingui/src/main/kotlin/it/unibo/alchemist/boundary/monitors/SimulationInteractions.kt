...
@SuppressFBWarnings(
    ...
    "Because the analysis only looks at the generated bytecode, " +
        "this warning can be incorrect triggered if the default " +
        "case is at the end of the switch statement and the switch" +
