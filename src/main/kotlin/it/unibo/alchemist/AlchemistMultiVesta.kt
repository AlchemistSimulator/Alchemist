...
import it.unibo.alchemist.adapter.AlchemistAdapter
import it.unibo.alchemist.adapter.SimultationAdapter
import it.unibo.alchemist.cli.CLIMaker
import it.unibo.alchemist.launch.AlchemistMultiVestaSimulationLauncher
...
object AlchemistMultiVesta {
     ...
     */
    fun launch(seed: Int, args: Array<String>): SimultationAdapter {
        ...
        try {
            ...
            return AlchemistAdapter(AlchemistMultiVestaSimulationLauncher.simulation)
