...
data class SimulationConfig(
    ...
    @JsonProperty(parametersKey)
    val parameters: SimulationConfigParameters = SimulationConfigParameters(),
) {
    ...
    companion object {
         ...
         * Defaults to HeadlessSimulationLauncher
         */
        const val defaultLauncherType = "HeadlessSimulationLauncher"
